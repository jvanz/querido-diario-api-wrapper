...
class SubthemesSearchResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subthemes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subthemes", ], str]):
